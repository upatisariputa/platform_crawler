...
class Info(models.Model):
    bj_key = models.AutoField(primary_key=True)
    bj_num = models.IntegerField()
    bj_name = models.CharField(max_length=50, blank=True, null=True)
    bj_img_url = models.CharField(max_length=300, blank=True, null=True)
    bj_cre_date = models.DateField()
    bj_platform = models.CharField(max_length=50, blank=True, null=True)
    bj_url = models.CharField(max_length=300, blank=True, null=True)
...
class SubGapDay(models.Model):
    sub_d_key = models.AutoField(primary_key=True)
    sub_d_date = models.DateField()
    sub_d_cnt = models.IntegerField(blank=True, null=True)
    sub_key = models.ForeignKey('Subscribe', models.DO_NOTHING, db_column='sub_key', blank=True, null=True)
...
class SubGapMonth(models.Model):
    sub_w_key = models.AutoField(primary_key=True)
...
class Subscribe(models.Model):
    sub_key = models.AutoField(primary_key=True)
    ...
    bj_num = models.ForeignKey(Info, models.DO_NOTHING, db_column='bj_num')
...
class Total(models.Model):
    total_key = models.AutoField(primary_key=True)
    ...
    bj_num = models.ForeignKey(Info, models.DO_NOTHING, db_column='bj_num', blank=True, null=True)
...
class Video(models.Model):
    video_key = models.AutoField(primary_key=True)
...
class VideoGapDay(models.Model):
    video_d_key = models.AutoField(primary_key=True)
    ...
    video_num = models.ForeignKey(Video, models.DO_NOTHING, db_column='video_num')
...
class VideoGapMonth(models.Model):
    video_m_key = models.AutoField(primary_key=True)
...
class VideoGapWeek(models.Model):
    video_w_key = models.AutoField(primary_key=True)
